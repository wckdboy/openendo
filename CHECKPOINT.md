...
- [x] **Ferroptosis direction deep-dive — DONE 2026-09-02** — verdict (`docs/research/evidence/ferroptosis-direction.md`): mechanism DOUBLE-EDGED, balance tilts disease-supporting (SEMA3C/Fer-1 rescue, VEGFA/IL8 angiogenesis, immune remodeling) → **sulfasalazine downgraded WRONG-DIRECTION (MEDIUM)**; concepts/ferroptosis.md + m3-validation.md row updated. *Percival*
