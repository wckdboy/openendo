...
- [x] **M3 knowledge pages (DoD del b) — DONE 2026-09-02** — entities/sirolimus-repurposing.md + concepts/mrgprx2-pain.md (SCHEMA: confidence medium, ≥2 wikilinks, verified sources — PMID 41170754, 40600649) + index.md (11 pages) + llms.txt. *Percival*
