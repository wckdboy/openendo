...
<!-- DRAFT for DrDoc review — 2026-09-14. Diff intent vs live entities/sirolimus.md:
     + registry re-check 2026-09-14 (still 0 trials, now including everolimus/temsirolimus/mTOR keyword)
     + cite S1PR4→mTOR (PMID 40532686) and PIK3/AKT/mTOR SNP study (PMID 40200774) as pathway context
     + keep FKBP4/PR-resistance as SEPARATE note (do not conflate)
...
- **No registered interventional trial** of rapamycin/sirolimus/everolimus/
  ...
  absent. See draft registry note `openendo-drafts/registry-verification-2026-09-14.md`.
...
- Phase 2 MD (FKBP12 crystal RAP control → FKBP52 Vina pose) remains blocked on
  GPU budget — docking alone does not settle pose claims.
